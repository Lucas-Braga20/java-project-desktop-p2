 ...
 * @author laboratorio
 */
public class IngredienteListagem extends javax.swing.JDialog {

    /**
     * Creates new form IngredienteListagem
     */
    public IngredienteListagem(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregarTabela();
    }
    ...
    public void carregarTabela() {
        try {
            ...
            for (int i = 0; i < ingredientes.size(); i++) {
                linhas[i][0] = ingredientes.get(i).getDescricao();
    ...
    private void initComponents() {
        ...
        setTitle("Listagem de ingredientes");
        ...
        jButtonAtualizar.setText("Atualizar Ingrediente");
        ...
        jTableIngredientes.setCellEditor(null);
        jScrollPaneTabela.setViewportView(jTableIngredientes);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        new IngredienteCadastro(new javax.swing.JFrame(), true, null).setVisible(true);
        carregarTabela();
    ...
    private void jButtonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoverActionPerformed
        // TODO add your handling code here:
        try {
            Integer indice = jTableIngredientes.getSelectedRow();
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        ...
        try {
            Integer indice = jTableIngredientes.getSelectedRow();
            new IngredienteCadastro(new javax.swing.JFrame(), true, ingredientes.get(indice)).setVisible(true);
            carregarTabela();
        } catch(IndexOutOfBoundsException e) {
            JOptionPane.showMessageDialog(null, "Selecione uma linha.", "Erro!", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngredienteListagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IngredienteListagem dialog = new IngredienteListagem(new javax.swing.JFrame(), true);
